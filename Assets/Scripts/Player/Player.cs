...
public class Player : MonoBehaviour
{
    ...
    public void Setup(string playerName, Transform parentTransform, Tilemap map, Vector3Int spawnPosition, GameController gameController)
    {
        ...
        transform.position = map.CellToWorld(spawnPosition) + new Vector3(0.5f, 0.5f, 0);
